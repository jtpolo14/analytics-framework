...
$REGION = "us-central1"
$JOB_NAME = "job-extractor-nhc-gtwo"
$IMAGE = "us-central1-docker.pkg.dev/dulcet-iterator-344116/cloud-run-source-deploy/job-extractor-nhc-gtwo-v1:latest"
$JOB_YAML = "job.yaml"
...
if ([string]::IsNullOrWhiteSpace($ACTIONS)) {
    ...
    Write-Host "  s = create scheduler job (daily at 10PM)"
    exit 1
}
...
function create_scheduler {
    ...
    Write-Host "  Schedule: $SCHEDULE (Daily at 10PM)"
