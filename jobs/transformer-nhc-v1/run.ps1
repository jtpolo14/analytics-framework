...
$REGION = "us-central1"
$JOB_NAME = "job-transformer-nhc-analytics"
$IMAGE = "us-central1-docker.pkg.dev/dulcet-iterator-344116/cloud-run-source-deploy/job-transformer-nhc-analytics:latest"
$JOB_YAML = "job.yaml"
$CLOUD_SQL_INSTANCE = "dulcet-iterator-344116:us-central1:de-course-dev"

if ([string]::IsNullOrWhiteSpace($ACTIONS)) {
    Write-Host "Usage: .\run.ps1 [i][r][u][e]"
